# Файлы
# Хранение данных, Передача данных в клиент-серверных проектах, Хранение конфигов, Логирование действий
...
path = 'file.txt' #все запишется в отдельный файл 
data = open(path, 'r')
for line in data:
 print(line)
data.close()
